        ...
        if($this->arraysqltable) {
            ...
            if($this->blockdisplaynodata != 1)
            {
                ...
                if(mysql_num_rows($result)==0)
                    echo "No data found<br><textarea rows=50 cols=150>$this->sql</textarea>";
                else
                    echo 'haha';
                exit(0);
            }             
...
*/  
     ...
     if($isPrintRepeatedValue=="true" ||$isPrintRepeatedValue=="") {
      return $result;  
            ...
            //$a["$this->currentuuid"]="ASDASD";
    //echo $a["$this->currentuuid"]."<br/>";  
    //echo $this->currentuuid.":".$this->lastrowresult["$this->currentuuid"]."- become -".$result."  === ";
